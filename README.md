...
| [12-input.md](docs/12-input.md) | Reading the player's active state: the twelve named input contexts, the `int32` index that selects one, the three objects involved, and the Steam Input handle that is not a pointer |
